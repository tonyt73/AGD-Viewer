...
{ __published: // IDE-managed Components
    ...
    void __fastcall cmbEventChange(TObject *Sender);
...
private: // User declarations
    ...
    void __fastcall OutputScreen(String& content, int room, int rx, int ry);
  String __fastcall PadLeft(unsigned int number, int size = 3);
